...
<div class='relative flex min-h-[calc(100vh-100px)] w-screen items-center'>
	...
	>
		...
		<div class='mt-8 flex flex-col justify-center gap-8'>
			...
			<div class='border-t border-b border-gray-200/30 py-10'>
				<h3 class='text-3xl font-medium text-gray-50'>Informations supplémentaires</h3>
		...
		<div class=''>
			<div class='flex flex-col gap-8'>
				<div class='relative'>
					<div
						class='absolute left-0 top-0 h-[100px] w-[100px] -translate-x-[50px] -translate-y-[50px] transform text-white opacity-25'
					>
						<svg
							version='1.1'
							id='Capa_1'
					...
					<div
						class='absolute bottom-0 right-0 h-[100px] w-[100px] translate-x-[50px] translate-y-[50px] -scale-x-100 transform text-white opacity-25'
					>
						<svg
							version='1.1'
							id='Capa_1'
