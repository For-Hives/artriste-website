...
<div class="w-screen">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 lg:py-[50px]">
		<div class="">
			<nav
				...
				<ol class="flex items-center space-x-4">
					...
					>
						<div class="flex items-center text-2xl">
							<a href="/galerie" class="mr-4 text-3xl font-medium text-gray-500"
								>Galerie</a
							>
							<svg
								viewBox="0 0 6 20"
		...
		<!-- Product details -->
		<div class="hidden lg:max-w-lg lg:self-end">
			<!--			<div class='mt-4'>-->
		...
		<!-- Product form -->
		<div
			class="mt-10 hidden lg:col-start-2 lg:row-start-2 lg:max-w-lg lg:self-start"
		>
