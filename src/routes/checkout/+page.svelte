...
<div class="flex flex-col-reverse sm:flex-row w-screen p-0 ">
    ...
    <div class="flex flex-col w-full justify-center items-center  ">
        <div class="w-full sm:w-1/2 px-4 py-6 space-y-6 bg-white border-2 border-gray-300 rounded-md shadow-md sm:px-6 lg:px-8">
            <div>
    ...
    <div class=" w-full flex flex-col justify-center items-center h-screen sm:h-fit ">
        {#if data.oeuvre}
            ...
            <img src={ api_origin + data.oeuvre.collectionId + "/" + data.oeuvre.id + "/" + data.oeuvre.image}
